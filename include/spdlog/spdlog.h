...
void spdlog_logger_call(const srcloc& loc, spdlog::logger* logger, spdlog::level::level_enum level, Args... args)
{
...
struct spdlog_trace
{
    spdlog_trace(Args&&... args, const srcloc& loc = srcloc::current())
    {
...
{
    spdlog_logger_trace(spdlog::logger* logger, Args&&... args, const srcloc& loc = srcloc::current())
    {
        if constexpr (SPDLOG_ACTIVE_LEVEL <= SPDLOG_LEVEL_TRACE)
...
struct spdlog_debug
{
    spdlog_debug(Args&&... args, const srcloc& loc = srcloc::current())
    {
...
{
    spdlog_logger_debug(spdlog::logger* logger, Args&&... args, const srcloc& loc = srcloc::current())
    {
        if constexpr (SPDLOG_ACTIVE_LEVEL <= SPDLOG_LEVEL_DEBUG)
...
struct spdlog_info
{
    spdlog_info(Args&&... args, const srcloc& loc = srcloc::current())
    {
...
{
    spdlog_logger_info(spdlog::logger* logger, Args&&... args, const srcloc& loc = srcloc::current())
    {
        if constexpr (SPDLOG_ACTIVE_LEVEL <= SPDLOG_LEVEL_INFO)
...
struct spdlog_warn
{
    spdlog_warn(Args&&... args, const srcloc& loc = srcloc::current())
    {
...
{
    spdlog_logger_warn(spdlog::logger* logger, Args&&... args, const srcloc& loc = srcloc::current())
    {
        if constexpr (SPDLOG_ACTIVE_LEVEL <= SPDLOG_LEVEL_WARN)
...
struct spdlog_error
{
    spdlog_error(Args&&... args, const srcloc& loc = srcloc::current())
    {
...
{
    spdlog_logger_error(spdlog::logger* logger, Args&&... args, const srcloc& loc = srcloc::current())
    {
        if constexpr (SPDLOG_ACTIVE_LEVEL <= SPDLOG_LEVEL_ERROR)
...
{
    spdlog_critical(Args&&... args, const srcloc& loc = srcloc::current())
    {
...
{
    spdlog_logger_critical(spdlog::logger* logger, Args&&... args, const srcloc& loc = srcloc::current())
    {
        if constexpr (SPDLOG_ACTIVE_LEVEL <= SPDLOG_LEVEL_CRITICAL)
